<?php
/**
 * Plugin Name: Calculate grades
 * Plugin URI:  https://foxland.fi/
 * Description: Calculate grades via form.
 * Version:     1.0.0
...
final class Plugin {
	...
	public function i18n() {
		load_plugin_textdomain( 'calculate-grades', false, trailingslashit( dirname( plugin_basename( __FILE__ ) ) ) . 'languages' );
	}
	...
	public function enqueue() {
		...
		wp_localize_script( 'calculate-grades-script', 'CalculateGradesText', array(
